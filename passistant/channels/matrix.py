...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install passistant-ai[matrix]"
    ) from e
...
from passistant.config.paths import get_data_dir, get_media_dir
from passistant.config.schema import Base
from passistant.utils.helpers import safe_filename
