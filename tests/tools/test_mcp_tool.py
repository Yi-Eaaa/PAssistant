...
from passistant.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from passistant.agent.tools.registry import ToolRegistry
from passistant.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("passistant.agent.tools.mcp.logger.warning", _warning)
