...
table, allowing passistant to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from passistant.channels import feishu
...
from passistant.channels.feishu import FeishuChannel
